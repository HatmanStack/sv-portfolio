...
<svelte:head>
	...
	<meta
		name="description"
		content="Technical blog posts on AWS, AI/ML, cloud development, and modern web technologies. Tutorials, insights, and project deep-dives by Christopher Galliart."
	/>
	...
	<meta
		...
		content="Technical blog posts on AWS, AI/ML, cloud development, and modern web technologies."
	/>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Technical blog posts on AWS, AI/ML, cloud development, and modern web technologies',
