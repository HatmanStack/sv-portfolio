...
export const webProjects: WebProject[] = [
	{
		...
		description:
			'AI image generation with React Native and AWS. Switch between diffusion models, apply style/layout modifications via IP Adapter, and explore prompt effects with the built-in generator.',
		initialImg: one,
	...
	},
	{
		...
		description:
			"Digital poetry archive inspired by MPR's Writer's Almanac. Features tsparticles ink-on-paper effect, Whisper audio transcription, and upcoming Llama-powered poem analysis with RAG.",
		initialImg: two,
		activeImg: twaa
	},
	{
		...
		description:
			'3D portfolio built with Three.js and React Fiber. Blender-generated scene with Draco compression—phones, lights, arcade controls, and signage are all interactive.',
		initialImg: three,
	...
	},
	{
		...
		description:
			'Serverless Node.js connector linking Google Forms to DynamoDB via App Scripts. Lightweight alternative to Rivery/Fivetran.  Submissions populate in ~1-2 minutes. Fill out the <a href="https://docs.google.com/forms/d/e/1FAIpQLSce94QihTjunjBvYzFdalz0mYGhVS6Ngy17uRrXkqLI_Da7nA/viewform?pli=1"><b>FORM</b></a> and check the data <a href="https://snow-node-sheets-gpc-357277717136.us-central1.run.app/dashboard"><b>HERE</b></a>',
		initialImg: four,
	...
	},
	{
		...
		description:
			'HuggingFace dataset (10K/100K) for LLM finetuning. Five task types: Creative Writing, Open Question, Poem, Q&A, and Brainstorm.',
		initialImg: five,
	...
	},
	{
		...
		description:
			"Adversarial multi-agent pipeline for Claude Code. Separate agents generate and critique each other's work in GAN-style loops. Includes skills for feature development, repo evaluation, health audits, and documentation drift detection.",
		initialImg: six,
	...
	},
	{
		...
		description:
			'AWS Nova Canvas foundation model in a Gradio app. Generate, edit, and refine images with text-to-image, inpainting, outpainting, background removal, color-guided manipulation, and image conditioning.',
		initialImg: eight,
		activeImg: novaCanvasa
	}
];

export const webContentMap = webProjects.reduce<Record<string, WebProject | ContentMapSeed>>(
	(acc, project) => {
